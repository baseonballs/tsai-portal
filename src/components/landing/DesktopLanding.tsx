          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-black/50 border border-cyan-500/30 rounded-2xl p-8 hover:border-cyan-500/50 transition-colors shadow-2xl">
                ...
                <h3 className="text-3xl font-serif text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-indigo-300 to-amber-400 mb-4 inline-block">Video Intelligence</h3>
              ...
              <div className="bg-black/50 border border-indigo-500/30 rounded-2xl p-8 hover:border-indigo-500/50 transition-colors shadow-2xl">
                ...
                <h3 className="text-3xl font-serif text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-indigo-300 to-amber-300 mb-4 inline-block">Player Reflection</h3>
                <ul className="space-y-3 text-sm text-zinc-300">

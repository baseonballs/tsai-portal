  ...
  return (
    <div className="relative min-h-screen bg-zinc-950 font-sans text-zinc-100 antialiased selection:bg-cyan-500/35 selection:text-white">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-sky-900/15 blur-[140px]" />
      </div>
      ...
      <main className="flex flex-col pt-16 relative z-10" suppressHydrationWarning>
        ...
        <section className="px-6 py-20 lg:px-8 border-y border-white/10 bg-gradient-to-r from-cyan-950/40 via-sky-950/40 to-amber-950/30 backdrop-blur-md">
        ...
        <section className="px-6 py-24 lg:px-8 bg-zinc-950">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-black/50 border border-sky-500/30 rounded-2xl p-8 hover:border-sky-500/50 transition-colors shadow-2xl">
                <span className="text-xs font-mono font-bold text-sky-400 uppercase block mb-2">Periodical Engine</span>
                <h3 className="text-3xl font-serif font-medium text-white mb-4 block">Player Reflection</h3>
                <ul className="space-y-3 text-sm text-zinc-300">
                  <li className="flex items-center gap-2"><Check className="w-4 h-4 text-sky-400" /> Interactive weekly planners and agendas</li>
                  <li className="flex items-center gap-2"><Check className="w-4 h-4 text-sky-400" /> Daily voice/text player journaling</li>
                  <li className="flex items-center gap-2"><Check className="w-4 h-4 text-sky-400" /> The Drop (hued cinematic cuts in journal)</li>
                  <li className="flex items-center gap-2"><Check className="w-4 h-4 text-sky-400" /> Read-back self-rating and Superpower trend lines</li>
                  <li className="flex items-center gap-2"><Check className="w-4 h-4 text-sky-400" /> Multi-Voice accountability (Player, Coach, Trainer, Mentor, Nutritionist, Parent, Scout)</li>
                </ul>
                <div className="mt-8 pt-6 border-t border-white/10">
                  <Link href="/players-development" className="text-sky-400 hover:text-sky-300 font-semibold text-xs flex items-center gap-1">
        ...
        <section className="px-6 py-24 lg:px-8 border-t border-white/5 bg-zinc-900/40">
          <div className="mx-auto max-w-5xl">
            <div className="text-center mb-12">
              ...
              <h2 className="mt-4 text-4xl font-serif text-white sm:text-5xl">Rink Telemetry and Spatial Intelligence</h2>
        ...
        <section id="beta-access" className="px-6 py-32 lg:px-8 border-t border-white/10 bg-gradient-to-b from-zinc-950 via-cyan-950/20 to-zinc-950 text-center relative overflow-hidden">
          <div className="mx-auto max-w-3xl relative z-10">
            ...
            <h2 className="mt-6 text-5xl font-serif tracking-tight text-white sm:text-7xl leading-tight">
              Bring <span className="text-zinc-400/80 font-semibold">Transcendental Sports </span><span className="text-cyan-400/80 font-sans">AI</span> to your <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-sky-300 to-amber-400">team.</span>
            </h2>

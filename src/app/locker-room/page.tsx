    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 selection:bg-cyan-500 selection:text-zinc-950 font-sans">
      ...
      <section className="relative overflow-hidden pt-16 sm:pt-24 pb-12 sm:pb-16 border-b border-white/5">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-cyan-300 shadow-sm">
            <Users className="h-3.5 w-3.5" />
            <span>The Shared Sanctuary of Athlete Development</span>
          </div>

          <h1 className="mt-6 text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl font-serif max-w-4xl mx-auto leading-tight">
          ...
          <p className="mt-5 text-base sm:text-lg lg:text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a
              href="#locker-hub"
              className="inline-flex items-center gap-2 rounded-xl bg-cyan-500 px-6 py-3.5 text-sm font-semibold text-zinc-950 shadow-xl shadow-cyan-500/20 transition-all hover:bg-cyan-400 active:scale-95 min-h-[48px]"
            >
            ...
            <a
              href="#superpowers"
              className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-zinc-900/60 px-6 py-3.5 text-sm font-semibold text-zinc-300 transition-all hover:border-white/20 hover:text-white active:scale-95 min-h-[48px]"
            >
